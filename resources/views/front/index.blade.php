...
<div class="container-fluid">
	...
	<div class="home-content">
		<div class="row">
		    <div class="banner">
          <img src="{{ asset('front_theme/img/b1.jpg') }}" alt="Banner" /></div>
	    </div>
	    <div class="container">
			<div class="row">
				<div class="home-text">
					<h1 class="text-center">Ecommerce website build using Laravel 5.5</h1>
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-4 text-center">
							<div class="col-icon"><img src="{{ asset('front_theme/img/doshas.png') }}" alt="" /></div>
						...
						<div class="col-sm-4 text-center">
							<div class="col-icon"><img src="{{ asset('front_theme/img/gluten-allergy.png') }}" alt="" /></div>
						...
						<div class="col-sm-4 text-center">
							<div class="col-icon"><img src="{{ asset('front_theme/img/diet.png') }}" alt="" /></div>
        ...
        <div class="container hidden-xs">
            <div id="hdLine"><span><h1>Our Product Range</h1></span><hr></div>
       		<div class="row">
       			<div class="col-xs-6 col-sm-4">
	    			<div class="itemBox bdr">
	    				<div class="prod"><img src="{{ asset('front_theme/img/1.jpg') }}" alt="" /></div>
	    		...
	    		<div class="col-xs-6 col-sm-4">
	    			<div class="itemBox bdr">
	    				<div class="prod"><img src="{{ asset('front_theme/img/2.jpg') }}" alt="" /></div>
	    		...
	    		<div class="col-xs-6 col-sm-4">
	    			<div class="itemBox bdr">
	    				<div class="prod"><img src="{{ asset('front_theme/img/3.jpg') }}" alt="" /></div>
       		...
       		<div class="row">
       			<div class="col-sm-4 text-center">
       				<div class="helpIco">
       					<img src="{{ asset('front_theme/img/free-shipping.png') }}" alt="" />
       				</div>
       			...
       			<div class="col-sm-4 text-center">
       				<div class="helpIco"><img src="{{ asset('front_theme/img/call-us.png') }}" alt="" /></div>
       			...
       			<div class="col-sm-4 text-center">
       				<div class="helpIco"><img src="{{ asset('front_theme/img/return-policy.png') }}" alt="" /></div>
       				<h5>Return Policy</h5>
