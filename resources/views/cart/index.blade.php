                              ...
                              <div class="cart-row">
                                  <div class="row">
                                    <div class="col-xs-12 col-sm-6 col-md-6 text-center">
                                      <img src="{{ asset('img/'.$pro->options->img) }}" class="img-responsive pull-left" />
                                    ...
                                    <div class="col-xs-12 col-sm-3 col-md-3">
                                      ...
                                      <div class="cart-qty"> <span>Qty : </span>
                                        ...
                                        value="{{$pro->qty}}" class="qty-fill" id="upCart{{ $pro->id }}">
                                      </div>
                                      <div><button class="btn btn-success">Update</button></div> <br>
