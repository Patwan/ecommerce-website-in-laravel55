...
<head>
	...
	<link href="{{Config::get('app.url')}}/node_modules/select2/dist/css/select2.min.css"
		rel="stylesheet"/>
    <link href="{{ asset('admin_theme/js/select2/dist/css/select2.min.css') }}"
        rel="stylesheet"/>
    ...
    <script src="{{ asset('admin_theme/js/jquery1.js') }}" type="text/javascript"></script>

</head>
<body>

<div class="wrapper">
    <div class="sidebar" data-color="blue" data-image="{{ asset('admin_theme/img/sidebar-5.jpg') }}">
	...
	<!--  Charts Plugin -->
	<script src="{{ asset('admin_theme/js/chartlist.min.js') }}"></script>
  ...
  -->
    ...
    <script src="{{ asset('admin_theme/js/select2/dist/js/select2.min.js') }}"></script>
